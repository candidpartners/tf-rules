...
const rule = require('./aws-security-group-allow-inbound');
const debug = require('debug')('tfrules/aws-security-group-allow-inbound.spec');
...
describe('aws-security-group-does-allow-inbound', function() {
