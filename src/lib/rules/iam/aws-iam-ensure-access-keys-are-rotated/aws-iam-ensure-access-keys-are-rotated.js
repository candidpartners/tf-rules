    ...
    return new RuleResult({
        ...
        resources: data.map(x => {
            ...
            return new Resource({
                ...
                message: isValid ? "has rotated its access keys." : `has an access key that has not been rotated in over ${dateRange} days, or has not been used since it was rotated.`
            })
        })
    });
};
